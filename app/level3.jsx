...
import level3Questions from '../assets/questions/level3';
...
const level3 = () => {
  ...
  useEffect(() => {
    const fetchHighScore = async () => {
      try {
        ...
        if (userSnap.exists()) {
          const level3HighScore = userSnap.data().highscores.level3;
          setHighScore(level3HighScore);
        }
  ...
  // tracks questions
  if (currentIndex < level3Questions.length - 1) {
      ...
      <View style={styles.content}>
        <View style={styles.card}>
          <Text style={styles.text}>
            {level3Questions[currentIndex].question}
          </Text>
        </View>
        
        <View style={styles.questionContainer}>
          <View style={styles.questionContainer}>
            {level3Questions[currentIndex].answers.map((answer, index) => (
